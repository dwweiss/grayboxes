...
_grayboxes_ contributes to the creation and evaluation of gray box models. A Python library for implementation of empirical, theoretical and hybrid models is provided. 
...
_grayboxes_ contributes to the creation and evaluation of hybrid models. A Python library for implementation of empirical, theoretical and hybrid models is provided. The generic model access and the possibility to distribute models over subdomains supports long-distance collaboration.
-->
